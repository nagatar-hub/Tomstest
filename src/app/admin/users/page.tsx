    ...
    <main className="flex-1 bg-gray-50 p-4">
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-white rounded-xl border p-4 mb-6 space-y-4">
          <div>
            <p className="text-sm font-medium text-gray-700 mb-2">スタッフログインリンク</p>
            <div className="flex gap-2 items-center">
              ...
              <button
                ...
                className="px-4 py-2 bg-amber-600 text-white rounded-lg text-sm hover:bg-amber-700 whitespace-nowrap"
              >
                {copiedLogin ? "コピー済み" : "コピー"}
              </button>
            </div>
            <p className="text-xs text-gray-400 mt-2">既にアカウントがあるスタッフにはこちらを共有してください。</p>
          </div>
